...
const monthlyStockReminderSchema = new Schema({
  ...
  // optional: follow-up alert if no checklist activity after windowDays
  followUpSentAt: { type: Date, required: false },
  followUpRecipients: [{ type: Schema.Types.ObjectId, ref: 'User' }]
}, { timestamps: true });
